(function () {
  ...
  waBtn.className = 'kws-wa-float';
  waBtn.style.cssText = 'position:fixed;bottom:1.2rem;right:1.2rem;z-index:8000;width:52px;height:52px;border-radius:50%;background:#25D366;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 16px rgba(37,211,102,0.45);transition:transform 0.2s,box-shadow 0.2s;text-decoration:none;-webkit-tap-highlight-color:transparent';
